...
export const Compare = ({
  ...
  return (
    <div
      ref={sliderRef}
      className={cn("w-[300px] sm:w-[400px] h-[400px] overflow-hidden", className)}
      style={{
        position: "relative",
    ...
    >
      <AnimatePresence initial={false}>
        <motion.div
          className="absolute top-0 m-auto z-30 bg-gradient-to-b from-transparent from-[5%] to-[95%] via-indigo-500 to-transparent"
          style={{
            left: `${sliderXPercent}%`,
            top: "0",
            zIndex: 40,
